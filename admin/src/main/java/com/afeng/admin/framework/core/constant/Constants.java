package com.afeng.admin.framework.core.constant;
...
public class Constants {
    ...
    public static final String CURRENT_USER = "adminUser";//当前登录用户
    ...
    /**
     * activeMq队列消息持久化
     * 存储redis方便swagger在线展示
     */
    public interface ActiveMqQueueData {//限流器时间间隔单位
        String SPRINGBOOT_QUEUE_TEST = "springboot.queue.test:";//springboot.queue.test队列
        String SPRINGBOOT_QUEUE_REVERSE = "springboot.queue.reverse:";//springboot.queue.reverse队列
        String SPRINGBOOT_TOPIC_TEST = "springboot.topic.test:";//springboot.topic.test主题
    }
