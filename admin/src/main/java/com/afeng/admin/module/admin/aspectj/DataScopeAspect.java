...
import com.afeng.admin.module.admin.model.BaseEntity;
...
public class DataScopeAspect {
    ...
    @Pointcut("@annotation(com.afeng.admin.module.admin.aspectj.lang.annotation.DataScope)")
    private void logAnnotation() {
    }

    @Pointcut("execution(public * com.afeng.admin.module.admin..*(..))")
    ...
    private void handleDataScope(final JoinPoint joinPoint) {
        ...
        // 获取当前的用户
        User currentUser = (User) SessionUtil.getSessionObject(Constants.CURRENT_USER);
        if (currentUser != null) {
            // 如果是超级管理员，则不过滤数据
