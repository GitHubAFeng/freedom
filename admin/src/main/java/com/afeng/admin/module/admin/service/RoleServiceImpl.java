...
import com.afeng.admin.module.admin.aspectj.lang.annotation.DataScope;
import com.afeng.admin.module.admin.dao.RoleDeptMapper;
import com.afeng.admin.module.admin.dao.RoleMapper;
import com.afeng.admin.module.admin.dao.RoleMenuMapper;
import com.afeng.admin.module.admin.dao.UserRoleMapper;
import com.afeng.admin.module.admin.model.Role;
import com.afeng.admin.module.admin.model.RoleDept;
import com.afeng.admin.module.admin.model.RoleMenu;
import com.afeng.admin.module.admin.model.UserRole;
...
public class RoleServiceImpl implements IRoleService {
    ...
    public int insertRole(Role role) {
        role.setCreateBy(AdminUtils.getSysUser().getLoginName());
        // 新增角色信息
        roleMapper.insertRole(role);
        AdminUtils.cleanSysUserPermissionCache(redisUtils);
    ...
    public int updateRole(Role role) {
        role.setUpdateBy(AdminUtils.getSysUser().getLoginName());
        // 修改角色信息
