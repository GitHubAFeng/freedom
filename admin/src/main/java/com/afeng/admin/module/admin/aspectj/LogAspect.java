...
import com.afeng.admin.module.admin.aspectj.lang.enums.BusinessStatus;
...
public class LogAspect {
    ...
    @Pointcut("@annotation(com.afeng.admin.module.admin.aspectj.lang.annotation.Log)")
    ...
    private void handleLog(final JoinPoint joinPoint, final Exception e, Object jsonResult) {
        try {
            ...
            // 获取当前的用户
            User currentUser = AdminUtils.getSysUser();
