...
import com.afeng.admin.module.admin.dao.DeptMapper;
import com.afeng.admin.module.admin.model.Dept;
...
public class DeptServiceImpl implements IDeptService {
    ...
    public int insertDept(Dept dept) {
        ...
        dept.setCreateBy(AdminUtils.getSysUser().getLoginName());
    ...
    public int updateDept(Dept dept) {
        ...
        dept.setUpdateBy(AdminUtils.getSysUser().getLoginName());
