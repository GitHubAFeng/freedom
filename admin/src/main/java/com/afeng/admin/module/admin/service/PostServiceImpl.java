...
import com.afeng.admin.module.admin.dao.PostMapper;
import com.afeng.admin.module.admin.dao.UserPostMapper;
...
public class PostServiceImpl implements IPostService {
    ...
    public int insertPost(Post post) {
        post.setCreateBy(AdminUtils.getSysUser().getLoginName());
    ...
    public int updatePost(Post post) {
        post.setUpdateBy(AdminUtils.getSysUser().getLoginName());
