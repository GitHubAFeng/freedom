...
import com.afeng.admin.module.common.constant.GenConstants;
import com.afeng.admin.module.common.model.GenTable;
import com.afeng.admin.module.common.model.GenTableColumn;
...
public class VelocityUtils {
    ...
    public static VelocityContext prepareContext(GenTable genTable) {
        ...
        velocityContext.put("businessName", genTable.getBusinessName());//根据表名去除前缀后自动生成的业务名
...
//            fileName = StringUtils.format("{}/{}/model/{}.java", javaPath, businessName, className);//使用业务名目录示例
            fileName = StringUtils.format("{}/model/{}.java", javaPath, className);
        } else if (template.contains("admin.java.vm")) {
        ...
        } else if (template.contains("admin.xml.vm")) {
            fileName = StringUtils.format("{}/admin/{}Mapper.xml", javaPath, className);
//            fileName = StringUtils.format("{}/{}Mapper.xml", mybatisPath, className);//存到resources目录示例
