package com.afeng.admin.module.quartz.service;

import com.afeng.admin.module.common.constant.ScheduleConstants;
import com.afeng.admin.module.common.utils.text.Convert;
import com.afeng.admin.module.quartz.dao.JobMapper;
import com.afeng.admin.module.quartz.model.Job;
import com.afeng.admin.module.quartz.util.CronUtils;
import com.afeng.admin.module.quartz.util.ScheduleUtils;
...
public class JobServiceImpl implements IJobService {
    ...
    public void init() throws SchedulerException, TaskException {
        log.debug("查询数据库中已存档的定时任务并进行初始化操作");
        scheduler.clear();
