...
import com.afeng.admin.module.admin.dao.MenuMapper;
...
import com.afeng.admin.module.common.utils.TreeUtils;
...
public class MenuServiceImpl implements IMenuService {
    ...
    public List<Menu> selectMenusByUser(User user) {
        ...
        if (user.isAdmin()) {
            ...
            AdminUtils.setSysUserPermissionCache(redisUtils, menus);
        }
