...
import com.afeng.admin.module.admin.dao.ConfigMapper;
import com.afeng.admin.module.admin.model.Config;
...
public class ConfigServiceImpl implements IConfigService {
    ...
    @Override
    public void init() {
        if (cacheUtil.exits(getCacheName())) return;
        ...
        for (Config config : configsList) {
            ...
            cacheUtil.hmset(getCacheName(), data);
        }
    }
    ...
    public String selectConfigByKey(String configKey) {
        Map<Object, Object> data = cacheUtil.hmget(getCacheName());
        ...
        if (StringUtils.isNotNull(retConfig)) {
            ...
            cacheUtil.hmset(getCacheName(), cdata);
