...
import com.afeng.admin.module.admin.service.IPostService;
import com.afeng.admin.module.admin.service.IRoleService;
...
public class UserController extends BaseController {
    ...
    public AjaxResult resetPwdSave(User user) {
        ...
        if (userService.resetUserPwd(user) > 0) {
            if (AdminUtils.getSysUser().getUserId().longValue() == user.getUserId().longValue()) {
